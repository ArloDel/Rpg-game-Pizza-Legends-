      ...
      gameObjects: {
        ...
        npcA: new Person({
          ...
          talking:[
            {
              events: [
                {type: "textMessage", text: "bla bla bla bla....", facehero: "npcA"},
                {type: "textMessage", text: "oh hello there !"}
        ...
        [utils.asGridCoord(7,4)] :[
          {
            events :[
              ...
              {type: "textMessage" ,text:" ojok nak kono cok !"},
      ...
      gameObjects: {
        ...
        npcB: new Person({
          ...
          talking: [
            {
              events:[
                {type: "textMessage", text:"Kau berhasil !", facehero:"npcB"}
              ]
            }
          ]
        })
